...
Based on your original settings but with problematic parts removed
"""
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    # We'll add your custom apps gradually
]
...
WSGI_APPLICATION = 'simplified_wsgi.application'
