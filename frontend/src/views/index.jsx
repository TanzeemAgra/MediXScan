            ...
            <Row>
                ...
                <Col md="12">
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title">
                                <h4 className="card-title">Global Medical Report Analysis</h4>
                                <p className="card-category">Distribution of medical reports analyzed across the world</p>
                            </div>
                        </Card.Header>
                        <Card.Body>
